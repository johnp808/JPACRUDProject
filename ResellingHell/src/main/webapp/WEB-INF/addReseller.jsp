...
<form action="createReseller.do" method="POST">
	...
	<br>
	Comic Book Sold: <input type="text" name="comicBooksSold" />
	<br>
	Hats Sold: <input type="text" name="hatsSold" />
	<br>
	Profit Made: <input type="text" name="profitMade" />
	<br>
	<input type="submit" value="Add New Reseller"/>
		</form>
